...
class DfuFlash:
    ...
    def __init__(self, eventCallback, progressCallback):
        ...
        self._dfuTimer.callback.append(self._dfuTimeout)
        self._sets = []
    ...
    def _onDeviceStateChanged(self, address, state):
        ...
        self._dm.dfuEvent.append(self._onDfuEvent)
        self._dm.dfuProgress.append(self._onDfuProgress)
        try:
            self._dm.deviceStateChanged.remove(self._onDeviceStateChanged)
        except ValueError:
            pass
